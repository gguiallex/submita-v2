...
export default async function NovoDepartamentoPage({
    ...
    // Se houver ID, poderíamos buscar os dados para editar, 
    // mas vamos focar no formulário de criação "UFLA Style"
